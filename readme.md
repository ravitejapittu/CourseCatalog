...
course Items JSON: `/course/<path:course_id>/menu/JSON`
    - Displays menu for a specific course

course Item JSON: `/course/<path:course_id>/<path:menu_id>/JSON`
    - Displays a specific course item.
